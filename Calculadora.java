...
public class Calculadora extends JFrame {
	...
	//los componentes de la ventana son las variables de la clase
			...
			private JButton sumar, restar, multiplicar, dividir,r_cuadrada,r_cubica, resultados;
			...
			private void inicializarComponentes() {
				...
				resultados.setBounds(280, 270, 45,45);
				resultados.setIcon(new ImageIcon("cube.png"));
				resultados.setBorder(new MatteBorder(null));
				add(resultados);
				resultados.addActionListener(new AdminEventos(this));
